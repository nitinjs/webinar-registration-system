...
namespace WMS.Migrations
{
    ...
    [Migration("20210221060805_testimonialPhoto")]
    partial class testimonialPhoto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Benefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.SpeakerPofile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.Testimonial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.Webinar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.WebinarDesign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.WebinarPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WMS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WMS.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WMS.Benefit", b =>
                {
                    b.HasOne("WMS.Webinar", "WebinarDetails")
                        .WithMany()
                        .HasForeignKey("WebinarId");

                    b.Navigation("WebinarDetails");
                });
            ...
            modelBuilder.Entity("WMS.Project", b =>
                {
                    b.HasOne("WMS.Authorization.Users.User", "UserDetails")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");
            ...
            modelBuilder.Entity("WMS.Webinar", b =>
                {
                    b.HasOne("WMS.Project", "ProjectDetails")
                        .WithMany()
