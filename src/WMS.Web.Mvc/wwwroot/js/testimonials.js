...
function loadTestimonials() {
    abp.services.app.testimonials.listAll({ id: webinarId }).done(function (result) {
        ...
        $.each(result, function (key, item) {
            ...
            html += '<td><a href="javascript:void(0)" onclick="return getTestimonialbyID(' + item.id + ')"><i class="fas fa-pencil-alt"></i></a> | <a style="color:red" href="javascript:void(0)" onclick="DeleleTestimonial(' + item.id + ')"><i class="fas fa-trash"></i></a></td>';
            html += '</tr>';
        });
        if (result.length == 0) {
            html += '<tr>';
