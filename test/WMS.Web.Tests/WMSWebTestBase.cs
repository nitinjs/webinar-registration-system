...
{
    public abstract class WMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WMSDbContext, Task<T>> func)
        {
            T result;
